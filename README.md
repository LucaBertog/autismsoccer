...
4. No **SQL Editor**, execute o conteúdo de `supabase/schema.sql`.
...
3. Clique em um hotspot existente para editar, reposicionar ou excluir.
4. Em **Reposicionar**, clique na nova posição na imagem.
